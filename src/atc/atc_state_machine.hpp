...
enum class ATCState {
  ...
  IFR_LINE_UP_AND_WAIT, // "line up and wait" issued, awaiting takeoff clearance
                        // request
  IFR_DEPARTURE_CLEARED, // "cleared for takeoff" issued IFR
  IFR_FREQ_HANDOFF,      // Tower issued Departure/Approach freq, awaiting pilot
                         // readback
  IFR_EN_ROUTE,          // on Departure frequency; pilot has not yet checked in
  IFR_RADAR_CONTACT,  // pilot checked in with Departure; ATC issuing SID step
                      // climbs
